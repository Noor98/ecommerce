...
$(document).ready(function(){
    // ال old 
    //عشان اذا اخترت دولة و مدينة و م اخترت اسم و ضغطت اضافة يقلي الايرور انو م في اسم و يضل محتفظ باسم الدولة و المدينة
  @if(old('country_id'))
  $.ajax({
  ...
  <div class="box-body">
    {!! Form::open(['url'=>aurl('states')]) !!}
     ...
     <div class="form-group">
        ...
        {!! Form::select('country_id',App\Country::pluck('country_name_'.session('lang'),'id'),old('country_id'),['class'=>'form-control country_id','placeholder'=>'.............']) !!}
     </div>
