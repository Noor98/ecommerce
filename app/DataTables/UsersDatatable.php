	...
	public function html() {
		return $this->builder()
			...
			->parameters([
				...
				'buttons'    => [
					[
						'text' => '<i class="fa fa-plus"></i> '.trans('admin.add'), 'className' => 'btn btn-default', "action" => "function(){
                    ...
                    ['extend' => 'pdf', 'className' => 'btn btn-default','text'=> '<i class="fa fa-file"></i> '. trans('admin.export_pdf')],
